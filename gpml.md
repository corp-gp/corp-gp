  ...
  <shop>
    ...
    <offers>
      ...
      <offer>
        ...
        <weight>2.550</weight>
        <!-- Объем жидкости в литрах. Объем можно указывать с точностью до тысячных (например, 1.001; разделитель целой и дробной части — точка). -->
        <volume>2.550</volume>
        <param name="Класс опасности">Не опасен </param>
